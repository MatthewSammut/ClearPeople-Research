...
export class RecentPagesHelper {
  ...
  private async fetchRecentPageItems(size: number, context: ApplicationCustomizerContext): Promise<IPage[]> {
  ...
  public getRecentPagesMenu(size: number, context: ApplicationCustomizerContext): Promise<IContextualMenuItem[]> {
